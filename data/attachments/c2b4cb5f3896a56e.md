...
- main:
  ...
  - text: Familj, Klassiker, Miyazaki x 10
  - heading "Prinsessan Mononoke - Klassiker" [level=1]
  - text: Jap tal, Sve text I dag 2 jul, kl 12:00 Filmstaden Rigoletto, Salong 3
  - link "Logga in och samla poäng":
    - /url: https://inte-services.cinema-api.com/redirect/externalSignUpOrIn/se?redirectUrl=https://sv-sit-marvel.filmstaden.se/bokning/kop/b9ed6663-e3e0-4a7a-b09c-da1683cd1e43/
  - button ""
  ...
  - dialog:
    ...
    - button ""
    - paragraph: Salongen har 63 platser på 8 rader. Gång finns på höger sida av salongen.
    - button "Stäng"
  - dialog
  - dialog
  - dialog
...
- text: Navigated to Prinsessan Mononoke - Klassiker
```
