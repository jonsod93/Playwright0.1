...
- main:
  ...
  - paragraph: test.1751426893970chromiumFRpurchase@mk4soayafs1u.mailisk.net
  - heading "Referensnummer" [level=2]
  - paragraph: Y6MTEXM3H8FU
  - paragraph: Tänk på att egna snacks, mat och dryck inte får tas med in på våra biografer.
  - link "Visa biljetter":
    - /url: /bokning/mina-e-biljetter/?reference=Y6MTEXM3H8FU
  ...
  - list:
    ...
    - listitem:
      - img "Min pappa Marianne"
      - img "Min pappa Marianne"
      - link "Min pappa Marianne":
        - /url: /film/min-pappa-marianne/
- contentinfo:
