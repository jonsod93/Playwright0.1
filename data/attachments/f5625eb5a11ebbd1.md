...
- main:
  ...
  - list:
    ...
    - listitem:
      - 'link "Downton Abbey: The Grand Finale - Rosa Kväll på Rigoletto"':
        - /url: /film/downton-abbey-the-grand-finale-rosa-kvall-pa-rigoletto/
    ...
    - listitem:
      ...
      - text: Konsert Premiär 24 september
    - listitem:
