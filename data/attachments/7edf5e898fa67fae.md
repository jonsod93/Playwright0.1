...
- main:
  ...
  - text: Eng tal, Sve text I dag 8 aug, kl 12:00 Filmstaden Heron City, Salong 7
  - link "Logga in och samla poäng":
    - /url: https://inte-services.cinema-api.com/redirect/externalSignUpOrIn/se?redirectUrl=https://sv-sit-marvel.filmstaden.se/bokning/kop/f96aa369-d29a-45d1-9adf-c675ff8660e0/
  - button ""
  ...
  - text: "Vi har förvalt de bästa platserna. Byt plats genom att dra markören. Valda platser: Rad 6 Plats 63-64"
  - img
  - 'checkbox "Valda platser: Rad 6 Plats 63-64"'
  - 'checkbox "Valda platser: Rad 6 Plats 63-64"'
  - 'checkbox "Valda platser: Rad 6 Plats 63-64"'
  - 'checkbox "Valda platser: Rad 6 Plats 63-64"'
  - 'checkbox "Valda platser: Rad 6 Plats 63-64"'
  ...
  - dialog:
    ...
    - button ""
    - paragraph: Salongen har 130 platser på 11 rader. Extra benutrymme finns på rad 4.
    - paragraph: Det finns hörslinga, barnkuddar och plats för rullstol. Placering för att kunna använda hörslinga är på näst sista raden på de fyra mittersta platserna. För reservation av rullstolsplatser ring 08-56 26 00 00.
    - button "Stäng"
  - dialog
  - dialog
  - dialog
  ...
  - dialog
  - dialog
  - text: "Summa: 270.00 kr Ordinarie 2 st 270.00 kr"
- text: Navigated to Se "Babyteeth" på bio - Köp biobiljett online | Filmstaden
```
