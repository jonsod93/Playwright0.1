...
- main:
  ...
  - text: Utmärkt film
  - heading "Weathering with You" [level=1]
  - text: Jap tal, Sve text I dag 25 maj, kl 12:00 Saga, Salong 3
  - link "Logga in och samla poäng":
    - /url: https://inte-services.cinema-api.com/redirect/externalSignUpOrIn/se?redirectUrl=https://sv-sit-marvel.filmstaden.se/bokning/kop/4272eb40-13d8-4119-ba8d-c7ba183755da/
  - button ""
  ...
  - text: "Vi har förvalt de bästa platserna. Byt plats genom att dra markören. Valda platser: Rad 3 Plats 26-27"
  - img
  - 'checkbox "Valda platser: Rad 3 Plats 26-27"'
  - 'checkbox "Valda platser: Rad 3 Plats 26-27"'
  - 'checkbox "Valda platser: Rad 3 Plats 26-27"'
  - 'checkbox "Valda platser: Rad 3 Plats 26-27"'
  - 'checkbox "Valda platser: Rad 3 Plats 26-27"'
  ...
  - dialog:
    ...
    - button ""
    - paragraph: Salongen har 82 platser på 7 rader.
    - paragraph: Det finns hörslinga, barnkuddar och plats för rullstol. Salongen är inte anpassad för elrullstol. Vid användning av hörslinga ska man meddela personalen som då slår på den, bästa placering är i mitten. För reservation av rullstolsplatser ring 08 - 56 26 00 00.
    - button "Stäng"
  - dialog
  - dialog
  - dialog
  ...
  - dialog
  - dialog
  - text: "Ordinarie 2 st 200.00 kr Summa: 200.00 kr"
- text: Navigated to Se Weathering with You på bio - Köp biobiljett online | Filmstaden
```
