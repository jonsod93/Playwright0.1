...
- main:
  ...
  - list:
    ...
    - listitem:
      - 'img "One to One: John & Yoko"'
      - 'img "One to One: John & Yoko"'
      - 'link "One to One: John & Yoko"':
        - /url: /film/one-to-one-john-yoko/
      - text: Biografi
    - listitem:
  ...
  - list:
    ...
    - listitem:
      - img "David Gilmour Live at the Circus Maximus, Rome"
      - img "David Gilmour Live at the Circus Maximus, Rome"
      - link "David Gilmour Live at the Circus Maximus, Rome":
        - /url: /film/david-gilmour-live-at-the-circus-maximus-rome/
      - text: Musik Premiär idag
    - listitem:
      - link "Djurexpressen":
        - /url: /film/djurexpressen/
      - text: Animerat Premiär 19 september
    - listitem:
      - img "Från din älskade Hilde"
      - img "Från din älskade Hilde"
      - link "Från din älskade Hilde":
        - /url: /film/fran-din-alskade-hilde/
      - text: Drama Premiär 19 september
    - listitem:
      - img "Tesciowie 3"
      - img "Tesciowie 3"
      - link "Tesciowie 3":
        - /url: /film/tesciowie-3/
      - text: Komedi Premiär 19 september
  - button "Visa fler filmer"
