...
- main:
  ...
  - list:
    ...
    - listitem:
      - img "Nausicaä från vindarnas dal - Klassiker"
      - img "Nausicaä från vindarnas dal - Klassiker"
      - link "Nausicaä från vindarnas dal - Klassiker":
        - /url: /film/nausicaa-fran-vindarnas-dal-klassiker/
      - button "Klassiker" [disabled]
      - text: Animerat Premiär 19 oktober
  - button "Visa fler filmer"
