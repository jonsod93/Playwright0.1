...
- main:
  ...
  - text: "Standard Rad 4, Plats 39 Ordinarie 149.00 kr Standard Rad 4, Plats 40 Ordinarie 149.00 kr Summa: 298.00 kr"
  - heading "Motel Destino" [level=1]
  - text: Por tal, Sve text I dag 31 okt, kl 11:00 Filmstaden Sergel, Salong 4
  - link "Logga in och samla poäng":
    - /url: https://inte-services.cinema-api.com/redirect/externalSignUpOrIn/se?redirectUrl=https://sv-sit-marvel.filmstaden.se/bokning/kop/1c308a6c-e3fc-481a-8cb1-549e343da468/
  - button ""
  ...
  - text: Rad 4, Plats 39,40
  - img
  - checkbox "Rad 4, Plats 39,40"
  - checkbox "Rad 4, Plats 39,40"
  - checkbox "Rad 4, Plats 39,40"
  - img
  - checkbox "Rad 4, Plats 39,40"
  ...
  - dialog:
    ...
    - button ""
    - paragraph: Salongen har 118 platser på 9 rader. Stolarna på rad 6 är Plusstolar med mer benutrymme. De är även bredare och har möjlighet till bakåtlutning, samt borttagning av armstöd. Plusstolarna kostar 20 kr extra.
  ...
  - dialog
  - dialog
- text: Navigated to Se "Motel Destino" på bio och köp biljetter online. | Filmstaden
```
