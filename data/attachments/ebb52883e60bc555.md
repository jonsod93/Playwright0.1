...
- main:
  - list:
    - listitem:
      ...
      - button "7+"
      - text: 1 tim 43 min Animerat, Äventyr,
      - link "Komedi":
        - /url: /genre/komedifilmer/
      - text: Familj
      - paragraph: Varför föddes Elsa med magiska krafter? Svaret hotar hennes kungarike. Tillsammans med Anna, Kristoffer, Olof och Sven ger hon sig ut på en farlig men häpnadsväckande resa.
      - paragraph: I Frost var Elsa rädd för att hennes krafter var för mycket för världen. I Frost 2 får hon hoppas att de är tillräckliga.
      - paragraph: "\"Frost 2\" har föreställningar i olika språkversioner: svenskt tal, engelskt tal och samiskt tal."
      - heading "Regi" [level=2]
      - paragraph: Chris Buck, Jennifer Lee
      - heading "Originaltitel" [level=2]
      - paragraph: Frozen 2
      - heading "Originalspråk" [level=2]
      - paragraph: Engelska
      - heading "Premiär" [level=2]
      - paragraph: 2019-12-25
