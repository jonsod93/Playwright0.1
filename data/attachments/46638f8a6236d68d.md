...
- main:
  ...
  - text: Eng tal, Ita tal, Fra tal, Sve text I dag 22 jul, kl 12:00 Filmstaden Söder (Tillfälligt stängd), Salong 1
  - link "Logga in och samla poäng":
    - /url: https://inte-services.cinema-api.com/redirect/externalSignUpOrIn/se?redirectUrl=https://sv-sit-marvel.filmstaden.se/bokning/kop/c87cba1b-b4ae-4d39-969d-c4e9e80c488a/
  - button ""
  ...
  - dialog:
    ...
    - button ""
    - paragraph: Salongen har 270 platser på 14 rader. Utgångarna ligger vänster sida längst bak och längst fram i salongen.
    - paragraph: Salongen har hörslinga och är anpassad för rullstol. För reservation av rullstolsplatser, ring 08-56 26 00 00.
    - button "Stäng"
  - dialog
  - dialog
  - dialog
