...
- main:
  ...
  - text: Por tal, Sve text I dag 22 okt, kl 12:00 Victoria Stockholm, Salong 7
  ...
  - dialog:
    ...
    - button ""
    - paragraph: Salongen har 46 platser på 4 rader.
    - paragraph: Salongen är anpassad för rullstol och det finns hörslinga i salongen. Salongerna tar inte permobil. För reservation av rullstolsplatser, ring 08-56 26 00 00.
    - button "Stäng"
  - dialog
  - dialog
  - dialog
