...
- main:
  ...
  - text: Familj
  - heading "Trubbel" [level=1]
  - text: Sve tal, Ej textad I dag 16 jun, kl 12:00 Saga, Salong 1
  - link "Logga in och samla poäng":
    - /url: https://inte-services.cinema-api.com/redirect/externalSignUpOrIn/se?redirectUrl=https://sv-sit-marvel.filmstaden.se/bokning/kop/e0ffc8c4-624c-4c6b-b796-3a980d1b0b2d/
  - button ""
  ...
  - text: "Vi har förvalt de bästa platserna. Byt plats genom att dra markören. Valda platser: Rad 10 Plats 208-209"
  - img
  - 'checkbox "Valda platser: Rad 10 Plats 208-209"'
  - 'checkbox "Valda platser: Rad 10 Plats 208-209"'
  - 'checkbox "Valda platser: Rad 10 Plats 208-209"'
  - 'checkbox "Valda platser: Rad 10 Plats 208-209"'
  - 'checkbox "Valda platser: Rad 10 Plats 208-209"'
  ...
  - dialog:
    ...
    - button ""
    - paragraph: Salongen har 588 platser på 24 rader. Dubbelsäten finns på rad 24.
    - paragraph: Observera att det är långa trappor upp till salong 1 så att de med svårigheter att gå kan få hjälp att gå in genom den nedre ingången om de kontaktar personal på plats med tidsmarginal till filmstart.
    - paragraph: Det finns hörslinga, barnkuddar och plats för rullstol. Maxvikt för rullstol är 225 kg inklusive person. För reservation av rullstolsplatser ring 08 - 56 26 00 00.
    - button "Stäng"
  - dialog
  - dialog
  - dialog
...
- text: Navigated to Se "Trubbel" på bio - Köp biobiljett online | Filmstaden
```
