...
- main:
  ...
  - text: "Summa: 368.00 kr Ordinarie 2 st 368.00 kr Familj"
  - heading "Wonka" [level=1]
  - text: Eng tal, Sve text I dag 12 okt, kl 10:00 Filmstaden Täby, Salong 3
  - link "Logga in och samla poäng":
    - /url: https://inte-services.cinema-api.com/redirect/externalSignUpOrIn/se?redirectUrl=https://sv-sit-marvel.filmstaden.se/bokning/kop/e62feda1-cec6-473e-8875-406ecf6cc38b/
  - button ""
  ...
  - dialog:
    ...
    - button ""
    - paragraph: "Salongen har 56 platser på 7 rader. Gång finns på båda sidorna av salongen och lutningen är god. Dukstorlek: 8,7m x 4,1m. Salongen har digitalt 7.1 ljud."
  ...
  - dialog
  - dialog
- text: Navigated to Se "Wonka" på bio - Köp biobiljett online | Filmstaden
```
