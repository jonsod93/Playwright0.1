...
- main:
  ...
  - text: Familj
  - heading "Operation Nordpolen" [level=1]
  - text: Sve tal, Ej textad I dag 27 jun, kl 12:00 Filmstaden Sergel, Salong 6
  - link "Logga in och samla poäng":
    - /url: https://inte-services.cinema-api.com/redirect/externalSignUpOrIn/se?redirectUrl=https://sv-sit-marvel.filmstaden.se/bokning/kop/c73efba1-4bea-4173-9264-ca19c4a7ebeb/
  - button ""
  ...
  - button "+": 
  - paragraph: Barn (t.o.m 11 år)
  - paragraph: Barnrabatt - 20% rabatt
  - button "-" [disabled]: 
  - spinbutton "Barn (t.o.m 11 år)" [disabled]: "0"
  - button "+": 
  - heading "Välj platser" [level=2]
  - text: "Vi har förvalt de bästa platserna. Byt plats genom att dra markören. Valda platser: Rad 3 Plats 24-25"
  - img
  - 'checkbox "Valda platser: Rad 3 Plats 24-25"'
  - 'checkbox "Valda platser: Rad 3 Plats 24-25"'
  - 'checkbox "Valda platser: Rad 3 Plats 24-25"'
  - img
  - 'checkbox "Valda platser: Rad 3 Plats 24-25"'
  ...
  - dialog:
    ...
    - button ""
    - paragraph: Salongen har 66 platser fördelat på sju rader. Stolarna på rad 6 är Plusstolar med mer benutrymme. Plusstolarna kostar 20 kr extra.
    - paragraph: Rullstolsplatser, hörslinga och barnkuddar finns. För reservation av rullstolsplatser ring 08 - 56 26 00 00.
    - button "Stäng"
  - dialog
  - dialog
  - dialog
...
- text: Navigated to Se "Operation Nordpolen" på bio - Köp biobiljett online | Filmstaden
```
