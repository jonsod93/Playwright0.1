...
- main:
  ...
  - text: Familj
  - heading "Hokus pokus Alfons Åberg" [level=1]
  - text: Sve tal, Ej textad I dag 29 jun, kl 12:00 Filmstaden Heron City, Salong 15
  - link "Logga in och samla poäng":
    - /url: https://inte-services.cinema-api.com/redirect/externalSignUpOrIn/se?redirectUrl=https://sv-sit-marvel.filmstaden.se/bokning/kop/64470e5d-f186-4751-a1e3-f2532f336867/
  - button ""
  ...
  - dialog:
    ...
    - paragraph: Det finns barnkuddar och plats för rullstol. Hörslingan fungerar inte för tillfället. För reservation av rullstolsplatser ring 08 - 56 26 00 00.
    - button "Stäng"
  - dialog
  - dialog
  - dialog
  ...
  - dialog
  - dialog
  - text: "Summa: 150.00 kr Ordinarie 2 st 150.00 kr"
- text: Navigated to Hokus pokus Alfons Åberg
```
