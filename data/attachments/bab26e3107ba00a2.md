...
- main:
  ...
  - list:
    - listitem:
      - img "Den vilda roboten"
      - img "Den vilda roboten"
      - link "Den vilda roboten":
        - /url: /film/den-vilda-roboten/
      - text: Animerat
    - listitem:
      - img "Bring Her Back"
      - img "Bring Her Back"
  ...
  - list:
    ...
    - listitem:
      ...
      - text: Äventyr
    - listitem:
      - img "Det andra offret"
      - img "Det andra offret"
      - img
      - text: "05"
      - img
      - link "Det andra offret":
        - /url: /film/det-andra-offret/
    ...
    - listitem:
      ...
      - img
      - link "Lilo & Stitch":
        - /url: /film/lilo-stitch/
      - text: Familj
  - heading "Välj dag du vill gå på bio" [level=2]
  - radio "Idag 11 sep" [checked]
  - text: Idag 11 sep
  - radio "fredag 12 sep"
  - text: fredag 12 sep
  - radio "lördag 13 sep"
  ...
  - list:
    ...
    - listitem:
      ...
      - button "50% med Biopasset" [disabled]
      - text: Drama Premiär 12 september
  - button "Visa fler filmer"
