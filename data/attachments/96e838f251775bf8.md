...
Call log:
  - waiting for locator('label').filter({ hasText: 'Jag är medveten om att filmen' }).first()
    - locator resolved to <label for="AgeLimitConfirmation" class="cursor-pointer select-none pl-8 pr-[0.125rem] text-sm peer-disabled:cursor-not-allowed peer-disabled:text-disabled">…</label>
  - attempting click action
    ...
    at ShowPage.acceptAgeLimit (/home/runner/work/Playwright0.1/Playwright0.1/pages/filmstaden_int/ShowPage.ts:100:43)
    at /home/runner/work/Playwright0.1/Playwright0.1/tests/filmstaden_int/purchases/cardPurchase.spec.js:73:7
