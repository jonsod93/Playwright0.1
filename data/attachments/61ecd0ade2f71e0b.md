...
- main:
  ...
  - text: Dokumentär
  - 'heading "Phil Lynott: Songs For While I''m Away" [level=1]'
  - text: Eng tal, Sve text måndag 16 jun, kl 19:54 Filmstaden Rigoletto, Salong 4
  - link "Logga in och samla poäng":
    - /url: https://inte-services.cinema-api.com/redirect/externalSignUpOrIn/se?redirectUrl=https://sv-sit-marvel.filmstaden.se/bokning/kop/6f30fde6-0696-4769-82eb-764583a0269d/
  - button ""
  ...
  - text: "Vi har förvalt de bästa platserna. Byt plats genom att dra markören. Valda platser: Rad 2 Plats 11, 13"
  - img
  - 'checkbox "Valda platser: Rad 2 Plats 11, 13"'
  - 'checkbox "Valda platser: Rad 2 Plats 11, 13"'
  - 'checkbox "Valda platser: Rad 2 Plats 11, 13"'
  - 'checkbox "Valda platser: Rad 2 Plats 11, 13"'
  - 'checkbox "Valda platser: Rad 2 Plats 11, 13"'
  ...
  - dialog:
    ...
    - button ""
    - paragraph: Salongen har 55 platser på 7 rader. Gång finns på vänster sida av salongen.
    - paragraph: Det finns plats för rullstol och salongen är utrustad med hörslinga. För reservation av rullstolsplatser, ring 08-56 26 00 00.
    - button "Stäng"
  - dialog
  - dialog
  - dialog
...
- text: "Navigated to Phil Lynott: Songs For While I'm Away"
```
