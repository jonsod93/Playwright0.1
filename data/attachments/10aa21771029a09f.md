...
- main:
  ...
  - text: Syntolkning, Uppläst text, Utmärkt film
  - heading "The Peanut Butter Falcon" [level=1]
  - text: Eng tal, Sve text I dag 2 jun, kl 12:00 Filmstaden Sergel, Salong 4
  - link "Logga in och samla poäng":
    - /url: https://inte-services.cinema-api.com/redirect/externalSignUpOrIn/se?redirectUrl=https://sv-sit-marvel.filmstaden.se/bokning/kop/51dcd409-3a04-4c79-b0a6-27347ff4b0c0/
  - button ""
  ...
  - text: "Vi har förvalt de bästa platserna. Byt plats genom att dra markören. Valda platser: Rad 5 Plats 54"
  - img
  - 'checkbox "Valda platser: Rad 5 Plats 54" [disabled]'
  - 'checkbox "Valda platser: Rad 5 Plats 54" [disabled]'
  - 'checkbox "Valda platser: Rad 5 Plats 54" [disabled]'
  - img
  - 'checkbox "Valda platser: Rad 5 Plats 54" [disabled]'
  ...
  - textbox "Ange en e-postadress": test.1748835120991chromiumFRpurchase@mk4soayafs1u.mailisk.net
  ...
  - list:
    ...
    - listitem:
      ...
      - text: Swish
  - separator
  - checkbox "Jag är medveten om att filmen är tillåten från 11 år. Barn som har fyllt 7 år får dock medfölja i vuxens (18 år) sällskap." [checked]
  - text: 
  ...
  - dialog
  - dialog
  - text: "Ordinarie 1 st 100.00 kr Summa: 100.00 kr"
- text: Navigated to Se The Peanut Butter Falcon på bio - Köp biobiljett online | Filmstaden
```
