...
Call log:
  ...
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      ...
      - done scrolling
      - <div class="relative flex flex-col gap-24 rounded-2xl p-24 md:p-[2.5rem] ">…</div> from <dialog open="" class="!block appearance-none transition-all duration-[0.25] backdrop:bg-weakest backdrop:opacity-70 dark">…</dialog> subtree intercepts pointer events
...
- main:
  ...
  - text: Sve tal, Sve text I dag 13 aug, kl 12:00 Grand Stockholm, Salong 1
