...
- main:
  ...
  - text: "Vi har förvalt de bästa platserna. Byt plats genom att dra markören. Valda platser: Rad 1 Plats 5-6"
  - img
  - img
  - 'checkbox "Valda platser: Rad 1 Plats 5-6"'
  - img
  - 'checkbox "Valda platser: Rad 1 Plats 5-6"'
  - img
  - 'checkbox "Valda platser: Rad 1 Plats 5-6"'
  ...
  - dialog:
    ...
    - button ""
    - paragraph: Salong VIP 3 har 37 platser fördelade på 4 rader. Salongen har extra breda, justerbara skinnfåtöljer och väl tilltaget benutrymme. Du har även möjlighet att ta med dig mat och dryck från intilliggande restaurangen Drama.
