...
- main:
  ...
  - text: Klassiker
  - heading "Trollkarlen från Oz - Klassiker" [level=1]
  - text: Eng tal, Sve text I dag 4 jul, kl 12:00 Saga, Salong 2
  - link "Logga in och samla poäng":
    - /url: https://inte-services.cinema-api.com/redirect/externalSignUpOrIn/se?redirectUrl=https://sv-sit-marvel.filmstaden.se/bokning/kop/f7240f01-ce5d-4b28-9307-7ea77f53ce2a/
  - button ""
  ...
  - dialog:
    ...
    - button ""
    - paragraph: Salongen har 115 platser på 7 rader.
    - paragraph: Det finns hörslinga, barnkuddar och plats för rullstol. Vid användning av hörslinga ska man meddela personalen som då slår på den, bästa placering är i mitten. För reservation av rullstolsplatser ring 08 - 56 26 00 00.
    - button "Stäng"
  - dialog
  - dialog
  - dialog
...
- text: Navigated to Se Trollkarlen från Oz - Klassiker på bio - Köp biobiljett online | Filmstaden.se
```
