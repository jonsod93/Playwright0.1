...
Error: expect.toContainText: Error: strict mode violation: getByRole('dialog') resolved to 8 elements:
    1) <dialog open="" class="!block appearance-none transition-all duration-[0.25] backdrop:bg-weakest backdrop:opacity-70 dark">…</dialog> aka getByRole('dialog').filter({ hasText: 'SalongsinformationI salong 14' })
...
- main:
  ...
  - text: Familj, VIP-salong
  - heading "Agatha - granndetektiven" [level=1]
  - text: Sve tal, Sve text I dag 12 jul, kl 12:00 Filmstaden Heron City, Salong 14 VIP (18-årsgräns)
  - link "Logga in och samla poäng":
    - /url: https://inte-services.cinema-api.com/redirect/externalSignUpOrIn/se?redirectUrl=https://sv-sit-marvel.filmstaden.se/bokning/kop/8308692e-f44e-4f23-a9a3-40bdfb4c6945/
  - button ""
  ...
  - text: "Vi har förvalt de bästa platserna. Byt plats genom att dra markören. Valda platser: Rad 4 Plats 22-23"
  - img
  - 'checkbox "Valda platser: Rad 4 Plats 22-23"'
  - 'checkbox "Valda platser: Rad 4 Plats 22-23"'
  - 'checkbox "Valda platser: Rad 4 Plats 22-23"'
  - 'checkbox "Valda platser: Rad 4 Plats 22-23"'
  - 'checkbox "Valda platser: Rad 4 Plats 22-23"'
  ...
  - dialog:
    ...
    - button ""
    - paragraph: I salong 14 är stolarna placerade i par, som stol 1-2, 3-4, 5-6 osv. Undvik att välja stolar med mellanrum (t.ex. stol 4-5), eftersom ni då sitter längre ifrån varandra.
    - paragraph: Salongen har 32 platser på 5 rader med gott om benutrymme. Sluttningen är rejält tilltagen och man ser mycket bra. Salongen har mycket bekväma VIP-stolar med benstöd och det går att luta tillbaka ryggstödet något. Pristillägg för VIP-stolar är 70 kr. Salongen har heltäckningsmattor och exklusivt trägolv i stolsfältet.
    - paragraph: Det finns hörslinga, barnkuddar och 2 platser för rullstol. Salongen har hörslinga. För reservation av rullstolsplatser ring 08-56 26 00 00.
    - button "Stäng"
  - dialog
  - dialog
  - dialog
  ...
  - dialog
  - dialog
  - text: "Summa: 310.00 kr Ordinarie VIP 2 st 310.00 kr"
- text: Navigated to Agatha - granndetektiven
```
