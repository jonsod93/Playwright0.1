...
- main:
  ...
  - heading "Horizon Line" [level=1]
  - text: Eng tal, Sve text I dag 10 jun, kl 12:00 Filmstaden Söder (Tillfälligt stängd), Salong 5
  - link "Logga in och samla poäng":
    - /url: https://inte-services.cinema-api.com/redirect/externalSignUpOrIn/se?redirectUrl=https://sv-sit-marvel.filmstaden.se/bokning/kop/ee6ec2a9-35ce-4b1f-8202-aa8bbd3090f0/
  - button ""
  ...
  - text: "Vi har förvalt de bästa platserna. Byt plats genom att dra markören. Valda platser: Rad 7 Plats 58-59"
  - img
  - 'checkbox "Valda platser: Rad 7 Plats 58-59"'
  - 'checkbox "Valda platser: Rad 7 Plats 58-59"'
  - 'checkbox "Valda platser: Rad 7 Plats 58-59"'
  - 'checkbox "Valda platser: Rad 7 Plats 58-59"'
  - 'checkbox "Valda platser: Rad 7 Plats 58-59"'
  ...
  - dialog:
    ...
    - button ""
    - paragraph: Salongen har 82 platser på 9 rader. Utgången ligger längst fram på höger sida av salongen.
    - paragraph: Salongen är utrustad med hörslinga och är anpassad för rullstol. För reservation av rullstolsplatser, ring 08-56 26 00 00.
    - button "Stäng"
  - dialog
  - dialog
  - dialog
  ...
  - dialog
  - dialog
  - text: "Summa: 260.00 kr Ordinarie 2 st 260.00 kr"
- text: Navigated to Se "Horizon Line" på bio - Köp biobiljett online | Filmstaden
```
