...
Call log:
  - waiting for getByRole('button', { name: 'Fortsätt till kortbetalning' })
    - locator resolved to <button type="button" class="relative rounded-full *:rounded-full *:focus-visible:outline *:focus-visible:outline-2 *:focus-visible:outline-offset-2 disabled:cursor-not-allowed duration-200 transition-colors ease-out  font-bold h-[2.75rem] text-base bg-brand text-button-primary border-0 hover:bg-brand-strong focus-visible:bg-brand focus-visible:outline-none active:text-button-primary-active active:bg-brand-stronger disabled:bg-disabled disabled:text-disabled w-full ">…</button>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <div class="flex h-[100vh] p-8 md:p-48 md:px-0 md:pb-0 md:pt-[2rem]">…</div> from <div class="bg p-24 h-auto rounded-base ">…</div> subtree intercepts pointer events
...
- main:
  ...
  - text: Sve tal, Sve text I dag 13 aug, kl 12:00 Filmstaden Sickla, Salong 4
  - link "Logga in och samla poäng":
    - /url: https://inte-services.cinema-api.com/redirect/externalSignUpOrIn/se?redirectUrl=https://sv-sit-marvel.filmstaden.se/bokning/kop/79c26858-2dec-4bd7-869c-37a287300533/
  - button ""
