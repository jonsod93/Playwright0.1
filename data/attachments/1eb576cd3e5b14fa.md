...
- main:
  ...
  - text: Sve tal, Sve text I dag 22 okt, kl 12:00 Filmstaden Råsunda, Salong 4 - "Bergman"
  - link "Logga in och samla poäng":
    - /url: https://inte-services.cinema-api.com/redirect/externalSignUpOrIn/se?redirectUrl=https://sv-sit-marvel.filmstaden.se/bokning/kop/752b4c7d-598c-4648-9b6a-17eed644fa36/
  - button ""
  ...
  - text: "Vi har förvalt de bästa platserna. Byt plats genom att dra markören. Valda platser: Rad 2 Plats 8-9"
  - img
  ...
  - dialog:
    ...
    - button ""
    - paragraph: Denna kulturminnesmärkta salong var visningsrum för studion på Filmstaden. Ingmar Bergman använde den också för sin filmklubb under sin period på Filmstaden. Salongen har 25 platser på 4 rader.
    - paragraph: Det finns hörslinga och barnkuddar. Salongen är inte anpassad för rullstol.
    - button "Stäng"
  - dialog
  - dialog
  - dialog
