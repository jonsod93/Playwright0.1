...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Referensnummer' })
    - waiting for" https://test.epayment.nets.eu/Terminal/default.aspx?merchantId=436756&transactionId=394eb07f972f4a2b9a1b4067c63ccf86" navigation to finish...
    - navigated to "https://sv-sit-marvel.filmstaden.se/bokning/kvitto-filmstaden/?showId=9c22ff87-02f2-4a9e-a7d4-5f61131be22b&rid=68af5472-02da-4982-b2b8-fe9f9bcfd004&payment=PAYMENTCARD&transactionId=394eb07f972f4a2b9…"
...
- main:
  ...
  - paragraph: CLHKSMI4JAOS
  - paragraph: Tänk på att egna snacks, mat och dryck inte får tas med in på våra biografer.
  - link "Visa biljetter":
    - /url: /bokning/mina-e-biljetter/?reference=CLHKSMI4JAOS
  - heading "Liknande filmer" [level=2]
  - list:
    - listitem:
      - img "Det här är min mamma"
      - img "Det här är min mamma"
      - link "Det här är min mamma":
        - /url: /film/det-har-ar-min-mamma/
    - listitem:
    ...
    - listitem:
      - link "The Life of Chuck":
        - /url: /film/the-life-of-chuck/
- contentinfo:
