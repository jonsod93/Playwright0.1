...
- main:
  ...
  - text: Sing-a-long
  - 'heading "Mamma Mia: Here We Go Again - Singalong" [level=1]'
  - text: Eng tal, Eng text I dag 3 jul, kl 12:00 Grand Lidingö, Salong 1
  - link "Logga in och samla poäng":
    - /url: https://inte-services.cinema-api.com/redirect/externalSignUpOrIn/se?redirectUrl=https://sv-sit-marvel.filmstaden.se/bokning/kop/54554cfe-8c92-4fe8-b8c2-600b4d81f730/
  - button ""
  ...
  - text: "Vi har förvalt de bästa platserna. Byt plats genom att dra markören. Valda platser: Rad 4 Plats 41-42"
  - img
  - 'checkbox "Valda platser: Rad 4 Plats 41-42"'
  - 'checkbox "Valda platser: Rad 4 Plats 41-42"'
  - 'checkbox "Valda platser: Rad 4 Plats 41-42"'
  - 'checkbox "Valda platser: Rad 4 Plats 41-42"'
  - 'checkbox "Valda platser: Rad 4 Plats 41-42"'
  ...
  - dialog:
    ...
    - button ""
    - paragraph: Salongen har 106 platser på 9 rader. Rad 9 är utrustad med plusstolar. Det är extra bekväma fåtöljer med extra benutrymme. Plusstolarna kostar 40 kr extra/stol.
    - paragraph: Det finns plats för rullstol. För reservation av rullstolsplatser ring 08 - 56 26 00 00.
    - button "Stäng"
  - dialog
  - dialog
  - dialog
...
- text: "Navigated to Mamma Mia: Here We Go Again - Singalong"
```
