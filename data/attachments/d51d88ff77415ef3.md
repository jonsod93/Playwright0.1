...
Call log:
  ...
  - waiting for locator('//h6[normalize-space()=\'Referensnummer\']')
    - waiting for" https://test.epayment.nets.eu/Terminal/default.aspx?merchantId=436756&transactionId=25479f3e39794b059ff28fbe461bff17" navigation to finish...
    - navigated to "https://test.epayment.nets.eu/Terminal/default.aspx?merchantId=436756&transactionId=25479f3e39794b059ff28fbe461bff17"
...
- group:
  - heading "502 - Web server received an invalid response while acting as a gateway or proxy server." [level=2]
  - heading "There is a problem with the page you are looking for, and it cannot be displayed. When the Web server (while acting as a gateway or proxy) contacted the upstream content server, it received an invalid response from the content server." [level=3]
```
